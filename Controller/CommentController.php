...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TzBlogBundle:Comment')->findAll();
     ...
     * @Method("POST")
     * @Template("TzBlogBundle:Comment:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Comment entitys.');
        }
     ...
     * @Method("POST")
     * @Template("TzBlogBundle:Comment:edit.html.twig")
     */
